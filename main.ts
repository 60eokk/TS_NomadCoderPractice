...
// Normally, we use interfaces when we want to shape objects or classes, and everytime else, we use types

// Polymorphism: How we can write code, that takes different shapes. We use generics to use polymorphism
interface SStorage<T> {
    [key:string] : T
}

class LocalStorage<T> {     // T is a generic
